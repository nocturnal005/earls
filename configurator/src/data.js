...
export const FRAME_PROFILES = [
  { id: 'pop-art', name: 'Pop Art 3mm', width: 3, price: 0 },
  { id: 'classic', name: 'Classic 20mm', width: 20, price: 15 },
  { id: 'slim', name: 'Slim 10mm', width: 10, price: 8 },
  { id: 'gallery', name: 'Gallery 15mm', width: 15, price: 12 },
];
...
export const FRAME_CATEGORIES = [
  { id: 'classic-wood',       name: 'Classic Wood',       count: 8 },
  { id: 'modern-flat',        name: 'Modern Flat',        count: 10 },
  { id: 'ornate-swept',       name: 'Ornate & Swept',       count: 7 },
  { id: 'gold-silver',        name: 'Gold & Silver',        count: 8 },
  { id: 'distressed-rustic',  name: 'Distressed & Rustic',  count: 7 },
  { id: 'painted-colour',     name: 'Painted & Colour',     count: 7 },
  { id: 'cushion-scoop',      name: 'Cushion & Scoop',      count: 7 },
  { id: 'box-tray',           name: 'Box & Tray',           count: 5 },
  { id: 'canvas-floater',     name: 'Canvas & Floater',     count: 4 },
  { id: 'slips-fillets',      name: 'Slips & Fillets',      count: 7 },
];
...
export const FRAME_CATALOGUE = [
  ...
  { id: 13, code:'LUNA/0002', name:'White Deep Rebate',       category:'modern-flat',       colour:'White',   hex:'#F5F5F0', finish:'Paint',      profile:'Flat',    widthMm:13,  depthMm:22, retailPerM:9.84 , image: 'mouldings/LUNA_0002.jpg'},
  ...
  // Gold & Silver (8)
  { id: 26, code:'5404/6008', name:'Flat Gold',               category:'gold-silver',       colour:'Gold',    hex:'#C8A84E', finish:'Gilt',       profile:'Flat',    widthMm:23,  depthMm:12, retailPerM:8.85 , image: 'mouldings/5404_6008.png'},
  { id: 27, code:'5401/7018', name:'Brushed Silver Ovaloe',   category:'gold-silver',       colour:'Silver',  hex:'#9A9A9A', finish:'Brushed',    profile:'Ovaloe',  widthMm:25,  depthMm:14, retailPerM:18.69 , image: 'mouldings/5401_7018.jpg'},
  ...
  { id: 32, code:'0135/0001', name:'Scratched Gold Raised',   category:'gold-silver',       colour:'Gold',    hex:'#B89040', finish:'Antiqued',   profile:'Raised',  widthMm:35,  depthMm:16, retailPerM:19.68 , image: 'mouldings/0135_0001.jpg'},
  { id: 33, code:'0135/0002', name:'Scratched Silver Raised', category:'gold-silver',       colour:'Silver',  hex:'#8C8C8C', finish:'Antiqued',   profile:'Raised',  widthMm:35,  depthMm:16, retailPerM:19.68 , image: 'mouldings/0135_0002.png'},
  // Distressed & Rustic (7)
