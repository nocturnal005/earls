...
export const FRAME_CATALOGUE = [
  ...
  { id: 'E073', code: 'ECON/0023', name: '20mm Obeche Brown',         colour: 'dark-wood', finish: 'Stained', profile: 'Flat',   widthMm: 20, heightMm: 15, costPerM: 1.51, hasPhoto: true, tier: 'everyday' },
  { id: 'E074', code: 'ECON/0018', name: '35mm Obeche Brown',         colour: 'dark-wood', finish: 'Stained', profile: 'Flat',   widthMm: 35, heightMm: 15, costPerM: 2.13, hasPhoto: true, tier: 'everyday' },
  { id: 'E075', code: 'ECON/0038', name: '38mm Stained Brown',        colour: 'dark-wood', finish: 'Stained', profile: 'Flat',   widthMm: 38, heightMm: 30, costPerM: 3.81, hasPhoto: true, tier: 'everyday' },
  { id: 'E076', code: 'ECON/0054', name: '15mm Dark Grey Flat',       colour: 'dark-wood', finish: 'Dark Grey', profile: 'Flat', widthMm: 15, heightMm: 13, costPerM: 1.15, hasPhoto: true, tier: 'everyday' },
  { id: 'E077', code: 'ECON/0053', name: '20mm Dark Grey Flat',       colour: 'dark-wood', finish: 'Dark Grey', profile: 'Flat', widthMm: 20, heightMm: 15, costPerM: 1.57, hasPhoto: true, tier: 'everyday' },
  { id: 'E078', code: 'ECON/0052', name: '35mm Dark Grey Flat',       colour: 'dark-wood', finish: 'Dark Grey', profile: 'Flat', widthMm: 35, heightMm: 15, costPerM: 2.13, hasPhoto: true, tier: 'everyday' },
  { id: 'E079', code: 'ECON/0051', name: '38mm Dark Grey Flat',       colour: 'dark-wood', finish: 'Dark Grey', profile: 'Flat', widthMm: 38, heightMm: 30, costPerM: 3.81, hasPhoto: true, tier: 'everyday' },
  { id: 'E080', code: 'ECON/0082', name: '22mm Brown Open Grain',     colour: 'dark-wood', finish: 'Open Grain', profile: 'Flat', widthMm: 22, heightMm: 22, costPerM: 1.71, hasPhoto: true, tier: 'everyday' },
  { id: 'E081', code: 'ECON/0075', name: '30mm Brown Open Grain',     colour: 'dark-wood', finish: 'Open Grain', profile: 'Flat', widthMm: 30, heightMm: 20, costPerM: 2.43, hasPhoto: true, tier: 'everyday' },
  { id: 'E082', code: 'ECON/0072', name: '40mm Brown Open Grain',     colour: 'dark-wood', finish: 'Open Grain', profile: 'Flat', widthMm: 40, heightMm: 20, costPerM: 2.89, hasPhoto: true, tier: 'everyday' },
  { id: 'E083', code: 'ECON/0069', name: '55mm Brown Open Grain',     colour: 'dark-wood', finish: 'Open Grain', profile: 'Flat', widthMm: 55, heightMm: 20, costPerM: 4.00, hasPhoto: true, tier: 'everyday' },
